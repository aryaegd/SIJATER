...
if (isset($_POST['verify'])) {
    ...
    $sql = "UPDATE laporan SET status_verifikasi='Disetujui', id_status=1 WHERE id_laporan=$id_laporan";
...
if (isset($_POST['reject'])) {
    $id_laporan = $_POST['id_laporan'];
    $sql = "UPDATE laporan SET status_verifikasi='Ditolak' WHERE id_laporan=$id_laporan";
    if ($conn->query($sql) === TRUE) {
        echo "Laporan berhasil ditolak.";
    } else {
        echo "Error: " . $conn->error;
    }
}
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4 space-grotesk-semi-bold">Laporan</h1>
                    <div class="card mb-4 ">
                        <div class="card-body dm-sans-medium">
                            Berikut adalah laporan kerusakan jalan yang belum diverifikasi.
                        </div>
                    </div>
                    <div class="card mb-4">
                        ...
                        <div class="card-body dm-sans-medium">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php
                                    $sql = "SELECT l.id_laporan, l.tgl_laporan, j.nama as nama_jalan, l.deskripsi
                                            FROM laporan l 
                                            JOIN jalan j ON l.id_jalan = j.id_jalan
                                            WHERE l.status_verifikasi='Belum Diverifikasi' AND YEAR(l.tgl_laporan) = 2024";
                                            ...
                                            echo "<tr>
                                                    ...
                                                    <td>
                                                        <form method='post' style='display:inline-block;'>
                                                            ...
                                                            <button type='submit' name='verify' class='btn btn-success'><i class='fas fa-check'></i></button>
                                                        </form>
                                                        <form method='post' style='display:inline-block;'>
                                                            <input type='hidden' name='id_laporan' value='" . $row["id_laporan"] . "'>
