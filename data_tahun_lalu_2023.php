...
<head>
    ...
    <title>SIJATER - Data Tahun 2023</title>
...
<body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4 dm-sans-medium">
                    <h1 class="mt-4 space-grotesk-semi-bold">Data Tahun 2023</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="index.html">Dashboard</a></li>
                        <li class="breadcrumb-item active">Data Tahun 2023</li>
                    </ol>
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-chart-line me-1"></i>
                            Line Chart Tahun 2023
                        </div>
                        <div class="card-body">
                            <canvas id="lineChart2023" style="width: 100%; height: 400px;"></canvas>
                        </div>
                    </div>
                </div>
            </main>
    ...
    <script>
        var ctx = document.getElementById("lineChart2023").getContext('2d');
